# VCFfinal.py version 1.5 2026-05-21
import datetime
import os
import subprocess
import sys
...
# Delete Supervisor to allow attendee to create it
if lsf.LMC and lsf.labtype == 'HOL':
    lsf.ssh(f'vcf context delete supervisor -y', 'holuser@console', lsf.password)
